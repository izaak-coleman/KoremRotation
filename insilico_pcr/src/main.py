...
def check_input_validity(input_params):
  ...
  if len(input_params) == N_INPUT_PARAMS:
    ...
    _, p1, p2, mantis_exec, mantis_ds, max_p1_mismatch, max_p2_mismatch, max_extension = input_params
  else:
  ...
  return p1, p2, mantis_exec, mantis_ds, max_p1_mismatch, max_p2_mismatch, max_extension
...
def main():
  ...
  p1, p2, mantis_exec, mantis_ds, max_p1_mismatch, max_p2_mismatch, max_extension = check_input_validity(sys.argv)
